{{ config(
    materialized='table',
    alias='custom_attributes_invecta',
    tags = ["bullhorn"]
) }}
...
WITH custom_attributes AS (
    ...
    UNION ALL
    SELECT 'Skillset' AS entity_name
    UNION ALL
    ...
    UNION ALL
    SELECT 'Project Skillset' AS entity_name
    UNION ALL
...
SELECT
    ...
    CASE 
        ...
        WHEN entity_name = 'Skillset' THEN 'skillset'
        ...
        WHEN entity_name = 'Project Skillset' THEN 'project_skillset'
    ...
    'options' AS type,
    CASE 
        WHEN entity_name IN ('Gender', 'Job Title', 'Specialism', 'Skillset', 'Desired Location', 'Business Area') THEN 'person'
        WHEN entity_name IN ('Company Type') THEN 'company'
        WHEN entity_name IN ('Project Job Title', 'Project Specialism', 'Project Skillset') THEN 'project'
        ELSE 'person'
    END AS of
